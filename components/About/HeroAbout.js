...
const WrapTitle = tw.div`col-span-7 flex flex-col h-full justify-end`;
const Title = tw.h1`font-bold font-common text-10xl leading-none mt-28 text-black`;
const Service = tw.div`flex items-center`;
